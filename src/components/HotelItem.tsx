...
export default function HotelItem({hotel}: {
    ...
    return <Link href={`/stay/${id}`} className={'rounded-xl max-md:grid grid-cols-3 gap-3 max-md:shadow max-md:px-4 max-md:py-2 p-4 transition-all duration-300 ease-in-out hover:p-2 hover:shadow-md hover:shadow-primary'}>
