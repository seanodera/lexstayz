...
export default function Navbar() {
    ...
    return <div
        ...
        <Link href={'/'} className={'text-3xl font-semibold block'}><Image height={100} width={100} className={`${pathName === '/' ? windowHeight >= 100 ? 'h-12' : ' h-16' : 'h-12'} transition-all duration-300 ease-linear`}
                                                                         ...
                                                                         alt={'logo'}/></Link>
        {(userDetails) ? <UserWidget/> : <Link href={'/login'}
