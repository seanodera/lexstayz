...
export default function Navbar() {
    ...
    return <div
        className={`w-full lg:px-24 px-7 flex items-center justify-between py-3 fixed top-0 left-0 z-50 ${pathName === '/' ? windowHeight >= 100 ? 'bg-white text-dark' : 'text-white ' : 'bg-white text-dark shadow-md shadow-primary-50'} transition-all duration-300 ease-linear`}>
