'use client'
import {Button, Card, Segmented, Slider, Checkbox, Select} from "antd";
...
export default function SearchPage() {
    ...
    const availableFilters = generateFilters();
            ...
            <div className={'grid grid-cols-5 gap-6'}>
                <div className={''}>
                    <Card>
                        ...
                        <div>
                            <h3>Price</h3>
                            <span className={'text-sm'}>{toMoneyFormat(lowestPrice)} - {toMoneyFormat(highestPrice)}</span>
                            <Slider
                                range
                                min={lowestPrice}
                                max={highestPrice}
